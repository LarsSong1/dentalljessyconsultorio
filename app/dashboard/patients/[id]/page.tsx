    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        ...
        <div className="flex space-x-2">
          ...
          <Button asChild>
            <Link href={`/dashboard/appointments/new?patientId=${patient.id}`} className="text-white">
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <Button className="w-full" variant="outline" asChild>
                <Link href={`/dashboard/patients/${patient.id}/medical-history`}>Ver Historial Completo</Link>
              </Button>
            </CardContent>
          </Card>
